...
#include "wr_ls_udp2/wr_ls_constants.h"
...
public:
    ...
    CWrLsCommon(CParserBase *parser, std::shared_ptr<rclcpp::Node> nh);
    virtual ~CWrLsCommon();
    virtual int  Init();
    int          LoopOnce();
...
//protected:
    //std::shared_ptr<diagnostic_updater::Updater> mDiagUpdater;
...
private:
    ...
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr mDataPublisher;
