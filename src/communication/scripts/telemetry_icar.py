...
class TelemetryIcar(Node):
    def __init__(self):
        self.has_init = False
        self.lock = Lock()

        super().__init__("telemetry_icar")
        ...
        logger.info("Node TelemetryIcar node has been initialized")
...
def main(args=None):
    ...
    node_telemetry_icar = TelemetryIcar()

    executor = rclpy.executors.MultiThreadedExecutor()
    executor.add_node(node_telemetry_icar)
    executor.spin()
