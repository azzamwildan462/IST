...
frame_kamera.src = "http://" + window.location.hostname + ":8080/stream?topic=/lane_kiri/frame_display&type=ros_compressed&quality=30"

const frame_binary = document.getElementById("frame_binary");
frame_binary.src = "http://" + window.location.hostname + ":8080/stream?topic=/lane_kiri/frame_binary&type=ros_compressed&quality=30"

const frame_aruco = document.getElementById("frame_aruco");
frame_aruco.src = "http://" + window.location.hostname + ":8080/stream?topic=/aruco_kiri/frame_display&type=ros_compressed&quality=30"
